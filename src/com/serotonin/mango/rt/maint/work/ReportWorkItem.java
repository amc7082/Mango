    ...
    public void execute() {
        ...
        for (ReportPointVO reportPoint : reportConfig.getPoints()) {
            ...
            if (point != null && Permissions.hasDataPointReadPermission(user, point)) {
                ...
                points.add(new ReportDao.PointInfo(point, colour, reportPoint.isConsolidatedChart(), reportPoint.getType(), reportPoint.getTitle(), reportPoint.getXLabel(), reportPoint.getYLabel(), reportPoint.getReferenceLine()));
            }
        }
